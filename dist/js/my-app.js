...
function getOfflineData(){
  ...
  if(offlineData != null){
      $.each(offlineData, function(index, value) {
            $$('#content-block-main').append('<div class="card demo-facebook-card">' +
              '<div class="card-header">' +
              '<div class="demo-facebook-avatar"><i id="catIcon" class="f7-icons" style="height:34px;width:34px;">bookmark</i></div>' +
              '<div class="demo-facebook-name">Selibeng.com | LesCAss</div>' +
              '<div class="demo-facebook-date">'+value.date+'</div>' +
                '</div>' +
                '<div class="card-content">' + 
                  '<div class="card-content-inner">' +
                   '<p>'+value.title.rendered+'</p>' +
